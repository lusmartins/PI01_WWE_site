    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 14,
                "vtp_instanceDestinationId": "G-3XPBT7BZ10",
                "tag_id": 26
            }, {
                ...
                "priority": 2,
                "vtp_eventName": "generate_lead_final",
                "vtp_isCopy": true,
                "vtp_instanceDestinationId": "G-3XPBT7BZ10",
                "vtp_precompiledRule": ["map", "new_event_name", "generate_lead_final", "merge_source_event_params", true, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_location"]], ["map", "type", "const", "const_value", "thank-you"]], "type", "cn"]]]]],
                "tag_id": 14
            }, {
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    ;
    aa.Qb = function() {
        for (var a = hb(this.C, 1), b = 0; b < this.h.length; b++)
            a.push(b + "");
        return new qb(a)
    }
    ;
...
*/
    ...
    var Rd = function(a, b, c, d) {
      ...
      , De = function(a, b, c, d, e) {
        ...
        try {
            ...
            if (!(r instanceof pd && a))
                throw f = r instanceof pd,
                r;
            var k = Ba(this.h)
              , m = new id(r);
            k.add(b, m);
    ...
    function Ie(a) {
        if (a instanceof wa || a instanceof dd || a instanceof qb || a instanceof rb || a instanceof id || null === a || void 0 === a || "string" === typeof a || "number" === typeof a || "boolean" === typeof a)
            return a
    }
    ;function Ke(a) {
        switch (a) {
    ...
    var kf = [], lf = [], mf = [], nf = [], of = [], pf = {}, qf, rf, sf = function(a) {
        rf = rf || a
    }, tf = function(a) {}, uf, vf = [], wf = function(a, b) {
        var c = {};
        c[Ne.wa] = "__" + a;
        for (var d in b)
        ...
        var e = pf[c], f = b && 2 === b.type && d.reportMacroDiscrepancy && e && -1 !== vf.indexOf(c), g = {}, k = {}, m;
        for (m in a)
        ...
        if (Ga(a)) {
            ...
            case "escape":
                d = yf(a[1], b, c);
                if (rf && Ga(a[1]) && "macro" === a[1][0] && rf.Hl(a))
                    return rf.fm(d);
                d = String(d);
    ...
    var Lf = function() {
      ...
      , Nf = function(a, b) {
        ...
        null != (d = c.h)[a] || (d[a] = []);
        c.h[a].push(function() {
            var e = b.apply, f, g = sa.apply(0, arguments);
      ...
      , L = function(a, b, c) {
        for (var d = 0; d < b.length; d++) {
            ...
            if (null == m) {
                ...
                if (n != k)
                    throw Error("Error in " + a + ". Argument " + f + " has type " + (Gg[n] || n) + ", which does not match required type " + (Gg[k] || k) + ".");
            }
        }
    };
    function Hg(a) {
      ...
      , Kg = function(a, b) {
        ...
        for (d in b)
            if (b.hasOwnProperty(d)) {
                var e = b[d];
                Da(e) ? c.set(d, Jg(a + "_" + d, e)) : mb(e) ? c.set(d, Kg(a + "_" + d, e)) : (Ea(e) || h(e) || "boolean" === typeof e) && c.set(d, e)
            }
        c.Ab();
        return c
    };
    ...
    function Yg(a, b) {
        var c = !1;
        L(K(this), ["booleanExpression:!string", "context:?PixieMap"], arguments);
        var d = JSON.parse(a);
        if (!d)
    ...
    var $g = function(a, b) {
      ...
      , ah = function(a, b) {
        ...
        if (c) {
            ...
            switch (d) {
            case "hitData":
                return 2 > a.length ? void 0 : $g(c.getHitData(a[1]), a.slice(2));
            case "metadata":
                return 2 > a.length ? void 0 : $g(c.getMetadata(a[1]), a.slice(2));
            case "eventName":
    ...
    Oh)
      , Qh = {}
      , Rh = (Qh.email = "sha256_email_address",
        ...
        Sh(a, function(c) {
            for (var d = ["tv.1"], e = 0, f = 0; f < c.length; ++f) {
                var g = c[f].name
                  ...
                  , m = c[f].index
                  , n = Ph[g];
                n && k && (-1 === Ih.indexOf(g) || /^e\d+$/.test(k) || Nh.test(k) || Lh.test(k)) && (void 0 !== m && (n += m),
                d.push(n + "." + k),
                e++)
            }
    ...
    Zh))
      ...
      , ci = Object.freeze([P.g.Fa, P.g.Gd, P.g.Vc, P.g.lf, P.g.Bd])
    ...
    ki.ke = Number("0") || 0;
    ki.fa = "dataLayer";
    ki.Oj = "ChEI8IS+qQYQ5srIuMf2j8HnARIlAMrt+XqHW+zlatC/6hs2LzvWF4vPtG5OmTwJy6Pm18BrZV7mvBoCkzE\x3d";
    var ni = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var fj;
    try {
        fj = JSON.parse(xb("eyIwIjoiQlIiLCIxIjoiQlItQ0UiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jb20uYnIiLCI0IjoiIiwiNSI6ZmFsc2UsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        N(123),
        ej(2),
        fj = {}
    ...
    var yj = function(a, b, c, d, e, f, g) {
        ...
        if (zj(p, n, e, f)) {
            ...
            q && z.setTimeout(function() {
                k[b] === r && r.quiet && (a.clearTimeout(b, void 0),
                a.notifyListeners(),
                zb("TAGGING", 2),
    ...
    aa.clearTimeout = function(a, b) {
        ...
        if (cj(4))
            for (var d in sj)
                sj.hasOwnProperty(d) && sj[d] === a && c.push(d);
        var e = this.entries[a] || {}
          , f = this.getConsentState(a);
        if (e.quiet) {
            e.quiet = !1;
            for (var g = fa(c), k = g.next(); !k.done; k = g.next())
                Aj(this, k.value)
    ...
    ;var Nj = [P.g.J, P.g.T, P.g.P, P.g.lb]
      ...
      , Sj = function(a) {
        ...
        ++d.dd)
            a.hasOwnProperty(P.g.Yf) && l(ji, function(e) {
                return function(f) {
      ...
      , pk = function() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.te = b.siloed[g],
                    !ek && Ha(f.te.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.te.ctid
                        }
                    }(f)) ? ek = !0 : c.push(f.te);
    ...
    function qk() {
        ...
        if (a.pending) {
            ...
            k++)
                g.jd = a.pending[k],
                Ha(g.jd.target.isDestination ? f : e, function(m) {
                    return function(n) {
    ...
    var sl = function(a, b, c, d) {
      ...
      , vl = /[?&]($|#)/
      , wl = function(a, b, c) {
        for (var d, e = a.search(tl), f = 0, g, k = []; 0 <= (g = sl(a, f, b, e)); )
    ...
    var Ml = function(a, b, c) {
        ...
        if (0 === k)
            ...
            m = 1 === k ? a.purpose && a.vendor ? Ll(a.purpose.legitimateInterests, b) && Ll(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return m
    }
      , Ll = function(a, b) {
        return !(!a || !a[b])
    ...
    var Sl = function() {
      ...
      , Yl = function() {
        ...
        if ((Ul() || T(72)) && !a.active && Jl(b)) {
            ...
            Vl(),
            T(72) && Xj([P.g.P]),
            a.tcString = "tcunavailable") : T(72) && Xj([P.g.J, P.g.lb, P.g.P]);
            try {
    ...
    function Xl(a) {
        var b = {}
          , c = (b[P.g.J] = a.Xb["1"] ? "granted" : "denied",
        b);
        T(72) && (c[P.g.lb] = a.Xb["3"] && a.Xb["4"] ? "granted" : "denied",
        "number" === typeof a.tcfPolicyVersion && 4 <= a.tcfPolicyVersion && (c[P.g.P] = a.Xb["1"] && a.Xb["7"] ? "granted" : "denied"));
        Qj(c, {
            eventId: 0
        }, {
    ...
    var lm = function(a) {
      ...
      , mm = function() {
        ...
        if (b && d)
            for (var f in tj)
                tj.hasOwnProperty(f) && tj[f].enabled && c.hasOwnProperty(f) && c[f].enabled ? e[f] = {
                    enabled: !0,
                    region: tj[f].region
                } : e[f] = {
                    enabled: !1,
    ...
    var Zm = {
      ...
      , $m = function(a, b) {
        ...
        d.qe !== a && (d.zm = a));
        ri ? (d.Qf = Zm[c],
        d.Qf || (d.Qf = 0)) : d.Qf = xi ? 13 : 10;
        vi ? d.th = 1 : Ym() ? d.th = 2 : d.th = 3;
        var e;
        var f = d.Qf
          , g = d.th;
        void 0 === f ? e = "" : (g || (g = 0),
        e = "" + Eg(1, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[f << 2 | g]);
        var k = d.mn, m = 4 + e + (k ? "" + Eg(2, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[k] : ""), n, p = d.mm;
        ...
        var y = d.qn
          ...
          , B = d.zm
          , D = d.rn;
        return m + n + q + t + (y ? "" + Eg(6, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[y] : "") + (A ? "" + Eg(7, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[A.length] + A : "") + (B ? "" + Eg(8, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[B.length] + B : "") + (D ? "" + Eg(9, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[D.length] + D : "")
    };
    var an = void 0;
    function bn(a) {
        var b = "";
    ...
    ;var Kn = /(.*?)\*(.*?)\*(.*)/
      ...
      , Nn = /([^?#]+)(\?[^#]*)?(#.*)?/;
    function On(a, b) {
        var c = [Cc.userAgent, (new Date).getTimezoneOffset(), Cc.userLanguage || Cc.language, Math.floor(Ta() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"), d;
        if (!(d = Dn)) {
    ...
    var Yn = function(a, b, c, d) {
      ...
      , $n = function() {
        ...
        var k = a.replace(Mn, ""), m = e.replace(Mn, ""), n;
        if (!(n = k === m)) {
            var p = "." + m;
    ...
    var Io = function(a, b) {
      ...
      , Ho = function(a) {
        return 0 !== Jo(a.split(".")).length ? 1E3 * (Number(a.split(".")[1]) || 0) : 0
    };
    function yo(a) {
        var b = Jo(a.split("."));
        ...
        if (tm(z)) {
            ...
            vo(function() {
                l(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = Ho(m), p = 0 !== Jo(m.split(".")).length ? m.split(".").slice(3) : [], q = {}, r;
    ...
    function Up(a) {
        var b = V(a.s, P.g.vb)
          , c = V(a.s, P.g.Kb);
        b && !c ? (a.eventName !== P.g.oa && a.eventName !== P.g.sd && N(131),
    ...
    var dq = []
      , eq = !(!z.IntersectionObserver || !z.IntersectionObserverEntry)
      , fq = function(a, b, c) {
        for (var d = new z.IntersectionObserver(a,{
            threshold: c
        }), e = 0; e < b.length; e++)
            d.observe(b[e]);
        for (var f = 0; f < dq.length; f++)
            if (!dq[f])
                return dq[f] = d,
                f;
        return dq.push(d) - 1
      ...
      , hq = function(a, b, c) {
        ...
        return z.setInterval(gq(a, b, c), 1E3)
    }
      , iq = function(a) {
        eq ? 0 <= a && a < dq.length && dq[a] && (dq[a].disconnect(),
        dq[a] = void 0) : z.clearInterval(a)
    };
    var kq = function(a, b, c) {
        ...
        if (a === F.body)
            ...
            if (a.id)
                ...
                if (a.parentElement) {
                    ...
                    d = jq(a.parentElement) + ">:nth-child(" + e + ")"
                } else
                    d = "";
                c = d
            }
      ...
      , wq = function() {
        ...
        for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
            var e = c[d];
            if (!(0 <= tq.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                for (var f = !1, g = 0; g < e.childElementCount && 1E4 > g; g++)
                    if (!(0 <= uq.indexOf(e.children[g].tagName.toUpperCase()))) {
                        f = !0;
                        break
                    }
                (!f || T(47) && -1 !== vq.indexOf(e.tagName)) && a.push(e)
            }
        }
        return {
            elements: a,
      ...
      , xq = !0
      , yq = !1;
    var rq = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i
      , zq = /@(gmail|googlemail)\./i
      , oq = /support|noreply/i
      , tq = "SCRIPT STYLE IMG SVG PATH BR NOSCRIPT TEXTAREA".split(" ")
      , uq = ["BR"]
      , Aq = {
        Nm: "1",
        bn: "2",
    ...
    var Uq = function(a) {
      ...
      , Vq = function(a) {
        return a.tagName + ":" + a.isVisible + ":" + a.W.length + ":" + zq.test(a.W)
    };
    var Wq, Xq;
    function Yq() {
        ...
        try {
            ...
            return Wq.parentElement.removeChild(Wq),
            Wq = void 0,
            !1
        }
        return !0
    ...
    ;var br = !1;
    function cr() {
        if (ar("join-ad-interest-group") && Da(Cc.joinAdInterestGroup))
            return !0;
        br || (zl(''),
        br = !0);
    ...
    Ut))
      ...
      , Yt = function(a, b, c) {
        if (Gk && "config" === a && !(1 < $o(b).O.length)) {
            ...
            for (k in d) {
                var m = Xt(d[k], f);
                m.length && (Wt && console.log(m),
                g.push(k))
            }
            g.length && (g.length && Gk && Rt.push(b + "*" + g.join(".")),
            zb("TAGGING", Tt[F.readyState] || 14));
            d[b] = f
        }
    };
    function Zt(a, b) {
    ...
    fu.prototype.addListener = function(a, b, c) {
        var d = ++this.I;
        this.h[a] = this.h[a] || {};
        this.h[a][String(d)] = {
            listener: b,
    ...
    var iu = function(a, b) {
      ...
      , ju = function(a, b, c, d) {
        if (oi.hasOwnProperty(b) || "__zone" === b)
            return -1;
        var e = {};
        mb(d) && (e = C(d, e));
        e.id = c;
    ...
    function Gu(a) {
        var b = a.eventId, c = a.Zb, d = Eu[b] || {}, e = [], f;
        for (f in d)
    ...
    var Pv = function(a, b) {
        ...
        var c = a["gtm.triggers"] && String(a["gtm.triggers"])
          , d = Ov.D(a.event, c ? String(c).split(",") : []);
        if (!d.length)
            return !1;
    ...
    function Uv(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (ni[d] || void 0 !== nf[c][Ne.Dk] || Ei[d] || ut(d, 2))
                    b[c] = !0
            }
        return b
    }
    function Vv(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && nf[c] && !oi[String(nf[c][Ne.wa])])
                return !0;
        return !1
    }
    var Xv = {};
    function Yv(a, b, c) {
        Gk && void 0 !== a && (Xv[a] = Xv[a] || [],
        Xv[a].push(c + b),
        Qk(a))
    }
    function Zv(a) {
        ...
        if (d.h) {
            ...
            if (f) {
                ...
                var r = d.h.prefix
                  ...
                  , u = jl(il(hl(gl(fl(dl(cl(el(bl(al($k(new Zk(d.messageContext.eventId,d.messageContext.priorityId), g), k), m), n), p), q), d.messageContext.eventMetadata), function() {
                    if (t) {
                        var v = t;
                        t = void 0;
                        v("2");
                ...
                try {
                    Yv(d.messageContext.eventId, r, "1"),
                    Yt(d.type, d.h.id, u),
                    f(d.h.id, b, d.D, u)
                } catch (v) {
    ...
    iw.prototype.push = function(a, b, c, d) {
        void 0 !== c && (1 === dw(this, c).status && (dw(this, c).status = 2,
        this.push("require", [{}], c, {})),
        dw(this, c).D && (d.deferrable = !1));
    ...
    iw.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
            ...
            if (f.messageContext.deferrable)
                !g || dw(this, g).D ? (f.messageContext.deferrable = !1,
    ...
    var kw = function(a, b) {
        if ("require" !== b.type)
            if (b.h)
                for (var c = dw(a, b.h).C[b.type] || [], d = 0; d < c.length; d++)
                    c[d]();
            else
                for (var e in a.C)
    ...
    var yw = {
        ...
        set: function(a, b) {
            var c;
            2 == a.length && mb(a[1]) ? c = C(a[1]) : 3 == a.length && h(a[1]) && (c = {},
            mb(a[2]) || Ga(a[2]) ? c[a[1]] = C(a[2]) : c[a[1]] = a[2]);
            if (c) {
                var d = tw(a, b)
                  , e = d.eventId
                  , f = d.priorityId;
        ...
        for (var a = !1, b; !bx && (b = ix()); ) {
            ...
            if (null == d)
                ...
                try {
                    ...
                    if ("number" === typeof u) {
                        for (var v = Yw[String(u)] || [], w = 0; w < v.length; w++)
                            $w.push(kx(v[w]));
                        v.length && $w.sort(cx);
                        delete Yw[String(u)];
                        u > Xw && (Xw = u)
    ...
    var $x = ["input", "select", "textarea"]
      , ay = ["button", "hidden", "image", "reset", "submit"]
      , by = function(a) {
        var b = a.tagName.toLowerCase();
        return 0 > $x.indexOf(b) || "input" === b && 0 <= ay.indexOf(a.type.toLowerCase()) ? !1 : !0
    }
      , cy = function(a) {
    ...
    var sy = function(a, b, c) {
        ...
        return {
            createEvent: function(g, k, m) {
                var n = a()
                  , p = n.ah
                  , q = void 0 !== m ? Math.round(m) : void 0 !== k ? Math.round(n.ah * k) : Math.round(n.dj)
                  , r = void 0 !== k ? Math.round(100 * k) : 0 >= p ? 0 : Math.round(q / p * 100)
                  , t = F.hidden ? !1 : .5 <= cq(c);
                d();
                var u = void 0;
                void 0 !== b && (u = [b]);
                var v = Tx(c, "gtm.video", u);
    ...
    ;function hz() {
        var a = ["&cv=1", "&rv=" + ki.Qg, "&tc=" + nf.filter(function(b) {
            return b
        }).length];
    ...
    function qz(a, b, c) {
        var d = this, e;
        L(K(this), ["eventName:!string", "callback:!Fn", "triggerId:?string"], arguments),
        pz([function() {
            return M(d, "listen_data_layer", a)
        }
        ]),
        e = Rv().addListener(a, md(b), c);
        return e
    }
    ...
    var Fz = function() {
        ...
        if (zz[c])
            ...
            Az.push(function(f) {
                ...
                if (g) {
                    var k = cy(g);
                    if (k) {
                        var m = Hz(k, "gtmFormInteractId", function() {
                            return Cz++
                        })
                          , n = Hz(g, "gtmFormInteractFieldId", function() {
                            return Dz++
                        })
                          , p = e[m];
                        p ? (p.Da && (z.clearTimeout(p.Da),
                        p.ma.dataset.gtmFormInteractFieldId !== n && Gz(p, d)),
                        p.ma = g,
                        Iz(p, d, a)) : (e[m] = {
                            form: k,
                            ma: g,
      ...
      , Gz = function(a, b) {
        ...
        e["gtm.interactedFormFieldPosition"] = dy(c, d, "gtmFormInteractFieldId");
    ...
    function Kz(a, b) {
        L(K(this), ["callback:!Fn", "options:?*"], arguments);
        var c = md(b) || {}
          , d = Number(c.interval);
        if (!d || 0 > d)
            d = 0;
        var e = md(a), f;
        Xx("pix.fil", "init") ? f = Xx("pix.fil", "reg") : (Fz(),
        f = Jz,
        Vx("pix.fil", "reg", Jz),
        Vx("pix.fil", "init", !0));
        f(d, e);
    ...
    var Mz = function(a, b, c) {
      ...
      , Nz = function(a, b) {
        var c = Xx("pix.fsl", a ? "nv.mwt" : "mwt", 0);
        z.setTimeout(b, c)
    }
      , Oz = function(a, b, c, d, e) {
        var f = Xx("pix.fsl", c ? "nv.mwt" : "mwt", 0)
          , g = Xx("pix.fsl", c ? "runIfCanceled" : "runIfUncanceled", []);
        if (!g.length)
            return !0;
        var k = Mz(a, c, e);
        N(121);
      ...
      , Qz = function() {
        ...
        HTMLFormElement.prototype.submit = function() {
            ...
            Oz(c, e, !1, Lz(c)) ? (b.call(c),
            d = !1) : Nz(!1, e)
        }
    };
    function Rz(a, b) {
        L(K(this), ["callback:!Fn", "options:?PixieMap"], arguments);
        var c = md(b) || {}
        ...
        if (d) {
            ...
            Wx("pix.fsl", "mwt", k, 0);
            f || Wx("pix.fsl", "nv.mwt", k, 0)
        }
        var m = function(n) {
            n.push(g);
            return n
        };
        Wx("pix.fsl", "runIfUncanceled", m, []);
        f || Wx("pix.fsl", "runIfCanceled", m, []);
        Xx("pix.fsl", "init") || (Qz(),
        Vx("pix.fsl", "init", !0));
    }
    ...
    function vA(a, b) {
        var c;
        L(K(this), ["preHit:!PixieMap", "dustOptions:?PixieMap"], arguments);
        var d = md(b) || {}
          , e = md(a, this.h, 1).jj()
          , f = e.s;
        d.omitEventContext && (f = jl(new Zk(e.s.eventId,e.s.priorityId)));
        var g = new sp(e.target,e.eventName,f);
    ...
    function zA(a, b) {
        var c = null;
        L(K(this), ["pattern:!string", "flags:?string"], arguments);
        try {
    ...
    function EA(a) {
        ...
        for (var f = d.elements, g = 0; g < f.length; g++)
            e.push(FA(f[g]));
        void 0 !== d.zh && b.set("preferredEmailElement", FA(d.zh));
                ...
                if (g) {
                    ...
                    if (k) {
                        var m = WA(k, "gtmFormInteractId", function() {
                          ...
                          , n = WA(g, "gtmFormInteractFieldId", function() {
                            return TA++
                        });
                        if (null !== m && null !== n) {
                            var p = e[m];
                            p ? (p.Da && (z.clearTimeout(p.Da),
                            p.ma.getAttribute("data-gtm-form-interact-field-id") !== n && UA(p, d)),
                            p.ma = g,
                            XA(p, d, b)) : (e[m] = {
                                form: k,
                                ma: g,
    ...
    function ZA(a, b) {
        var c = this;
        L(K(this), ["options:?PixieMap", "triggerId:?*"], arguments);
        T(71) ? pz([function() {
    ...
    var $A = function(a, b, c, d, e) {
        var f = Xx("fsl", c ? "nv.mwt" : "mwt", 0), g;
        g = c ? Xx("fsl", "nv.ids", []) : Xx("fsl", "ids", []);
        if (!g.length)
            return !0;
        var k = Tx(a, "gtm.formSubmit", g)
          , m = a.action;
    ...
    var sB = function(a, b) {
        ...
        if (0 < d) {
            var f = yn(zn(c))
              , g = yn(zn(z.location.href));
            return f !== g
        }
        return !0
    }
      , tB = function(a, b) {
        for (var c = xn(zn((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || Uc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
        ...
        var a = T(99) ? "lcl" : "aelc"
          ...
          , c = function(d) {
            ...
            if (e && 3 !== d.which && !(d.lh || d.timeStamp && d.timeStamp === b)) {
                ...
                var f = d.defaultPrevented || !1 === d.returnValue, g = Xx(a, f ? "nv.mwt" : "mwt", 0), k;
                k = f ? Xx(a, "nv.ids", []) : Xx(a, "ids", []);
                ...
                if (m.length) {
                    var r = sB(d, e)
                      , t = Tx(e, "gtm.linkClick", m);
                    t["gtm.elementText"] = Qc(e);
                    t["gtm.willOpenInNewWindow"] = !r;
                    if (r && !f && g && e.href) {
                        var u = !!Ha(String(Uc(e, "rel") || "").split(" "), function(y) {
    ...
    function vB(a, b) {
        var c = this;
        var d = T(99) ? "lcl" : "aelc";
        L(K(this), ["dustOptions:?PixieMap", "triggerId:?*"], arguments);
        var e = md(a);
        pz([function() {
    ...
    var yB = function(a) {
      ...
      , CB = function() {
        var a = 250
          , b = !1;
        F.scrollingElement && F.documentElement && z.addEventListener && (a = 50,
        b = !0);
        var c = 0
          , d = !1
          , e = function() {
            ...
            AB(),
            Xx("sdl", "init", !1) && !BB() && (Oc(z, "scroll", f),
            Oc(z, "resize", f),
            Vx("sdl", "init", !1)));
            d = !1
        }
      ...
      , AB = function() {
        var a = wB()
          , b = a.Yg
          , c = a.Zg
          , d = b / xB.scrollWidth * 100
          , e = c / xB.scrollHeight * 100;
        DB(b, "horiz.pix", "PIXELS", "horizontal");
        DB(d, "horiz.pct", "PERCENT", "horizontal");
        DB(c, "vert.pix", "PIXELS", "vertical");
        DB(e, "vert.pct", "PERCENT", "vertical");
        Vx("sdl", "pending", !1)
    }
      , DB = function(a, b, c, d) {
        var e = yB(b), f = {}, g;
      ...
      , EB = function() {
        ...
        return function() {
            var c = bq()
              , d = c.height;
            a = Math.max(xB.scrollLeft + c.width, a);
            b = Math.max(xB.scrollTop + d, b);
            return {
                Yg: a,
                Zg: b
            }
      ...
      , BB = function() {
        return !!(Object.keys(yB("horiz.pix")).length || Object.keys(yB("horiz.pct")).length || Object.keys(yB("vert.pix")).length || Object.keys(yB("vert.pct")).length)
    };
    function GB(a, b) {
        var c = this;
        L(K(this), ["options:!PixieMap", "triggerId:?*"], arguments);
        ...
        case "PIXELS":
            zB(d.horizontalThresholds, b, "horiz.pix");
            break;
        case "PERCENT":
            zB(d.horizontalThresholds, b, "horiz.pct")
        }
        switch (d.verticalThresholdUnits) {
        case "PIXELS":
            zB(d.verticalThresholds, b, "vert.pix");
            break;
        case "PERCENT":
            zB(d.verticalThresholds, b, "vert.pct")
        }
        Xx("sdl", "init", !1) ? Xx("sdl", "pending", !1) || I(function() {
            return AB()
        }) : (Vx("sdl", "init", !0),
        Vx("sdl", "pending", !0),
        I(function() {
    ...
    var nc = ca(["data-gtm-yt-inspected-"]), JB = ["www.youtube.com", "www.youtube-nocookie.com"], KB, LB = !1;
    var MB = function(a, b, c) {
      ...
      , PB = function(a, b) {
        ...
        function f(G) {
            ...
            case 1:
                ...
                y = a.getPlaybackRate();
                b.Vg ? dx(t.createEvent("start")) : t.Zc();
                u = MB(b.Bh, b.Ah, a.getDuration());
                return g(G);
            default:
                return f
            }
        ...
        function k(G) {
            ...
            case 3:
                ...
                E = 1 < Math.abs((Sa().getTime() - B) / 1E3 * y - H) ? "seek" : E || "buffering";
                a.getCurrentTime() && (b.Ug ? dx(t.createEvent(E)) : t.Zc());
                q();
                return m;
            case -1:
                return e(G);
        ...
        function n() {
            ...
            b.Tg && dx(t.createEvent("complete", 1));
            return e(-1)
        }
        function p() {}
        function q() {
        ...
        function r() {
            if (u.length && 0 !== y) {
                ...
                c = function() {
                    d = 0;
                    c = p;
                    0 < u.length && u[0].Aa === E.Aa && (u.shift(),
                    dx(t.createEvent("progress", E.Oe, E.Qe)));
                    r()
                }
                ;
      ...
      , SB = function(a, b) {
        ...
        if (UB(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = -1 !== c.indexOf("?") ? "&" : "?";
                -1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (KB || (KB = F.location.protocol + "//" + F.location.hostname,
                F.location.port && (KB += ":" + F.location.port)),
                d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(KB));
                var f;
                f = Jb(d);
                a.src = Hb(f).toString();
                return !0
      ...
      , UB = function(a, b) {
        ...
        for (var c = 0; c < JB.length; c++)
            if (0 <= a.indexOf("//" + JB[c] + "/" + b))
                return !0;
        return !1
    }
      , TB = function() {
        var a = Math.round(1E9 * Math.random()) + "";
        return F.getElementById(a) ? TB() : a
    };
    function VB(a, b) {
        var c = this;
        L(K(this), ["dustOptions:!PixieMap", "triggerId:?*"], arguments);
        ...
        var d = !!a.get("captureStart")
          ...
          , g = OB(md(a.get("progressThresholdsPercent")))
          , k = NB(md(a.get("progressThresholdsTimeInSeconds")))
        ...
        I(function() {
            for (var t = F.getElementsByTagName("script"), u = t.length, v = 0; v < u; v++) {
                ...
                if (UB(w, "iframe_api") || UB(w, "player_api"))
                    return b
            }
            for (var x = F.getElementsByTagName("iframe"), y = x.length, A = 0; A < y; A++)
                if (!LB && SB(x[A], n.ye))
    ...
    function zD() {
        ...
        a.set("containerId", 'G-3XPBT7BZ10'),
        a.set("version", '1'),
        a.set("environmentName", ''),
        a.set("debugMode", Xf),
        a.set("previewMode", Zf),
        a.set("environmentMode", Yf),
        T(77) && a.set("firstPartyServing", ti || vi),
        T(78) && a.set("containerUrl", Dc),
        a.Ab();
        return a
    }
    ...
    function PD(a, b) {
        var c;
        L(K(this), ["queryKey:!string", "retrieveAll:?boolean"], arguments);
        M(this, "get_url", "query", a);
        var d = xn(zn(z.location.href), "query")
          , e = un(d, a, b);
        c = ld(e, this.h);
        return c
    }
    ...
    function UD(a) {
        var b = "";
        L(K(this), ["component:?string"], arguments),
        M(this, "get_url", a),
        b = xn(zn(z.location.href), a);
        return b
    }
    UD.N = "getUrl";
    function VD() {
    ...
    VD.N = "getUserAgent";
    var WD = function(a) {
        return up(a, P.g.Jb, V(a.s, P.g.Jb)) || up(a, "google_ono", !1)
    }
      , XD = function(a) {
        if (a.metadata.is_merchant_center || !Kt(a.s))
            return !1;
        if (!V(a.s, P.g.Od)) {
            var b = V(a.s, P.g.Hd);
            return !0 === b || "true" === b
      ...
      , ZD = function(a, b) {
        var c = up(a, P.g.Fd, a.s.C[P.g.Fd]);
        if (c && void 0 !== c[b || a.eventName])
            return c[b || a.eventName]
    }
      , $D = function(a, b, c) {
        a.h[P.g.me] || (a.h[P.g.me] = {});
        a.h[P.g.me][b] = c
    };
    var aE = !1
      , bE = function(a) {
        var b = a.eventName === P.g.jc && Fj() && XD(a)
          ...
          , k = a.metadata.euid_mode_enabled && !!YD(a);
        return !(!Cc.sendBeacon || d || k || e || f || g || b || !c && aE)
    };
    var cE = function(a) {
        var b = 0
          , c = 0;
    ...
    aa.uk = function(a) {
        ...
        if (!this.h) {
            ...
            XD(a) && -1 === (Cc.userAgent || "").indexOf("Firefox") && -1 === (Cc.userAgent || "").indexOf("FxiOS") && c(z, "beforeunload", function() {
                aE = !0
            });
            this.Dh();
            this.C = 0
    ...
    var iE = function(a, b, c) {
      ...
      , lE = function(a, b) {
        ...
        var d = b.metadata.cookie_options
          , e = d.prefix + "_ga"
          , f = Cn(d, void 0, void 0, P.g.T);
        if (!1 === V(b.s, P.g.rb) && jE(b) === a)
            c = !0;
        else {
            var g = Wm(a, kE[0], d.domain, d.path);
            c = 1 !== Fm(e, g, f)
        }
        return c
    }
      , jE = function(a) {
        var b = a.metadata.cookie_options
          , c = b.prefix + "_ga"
          , d = Vm(c, b.domain, b.path, kE, P.g.T);
        if (!d) {
            var e = String(V(a.s, P.g.kc, ""));
            e && e != c && (d = Vm(e, b.domain, b.path, kE, P.g.T))
        }
        return d
    }
      , kE = ["GA1"]
      , mE = function(a, b) {
        var c = a.h[P.g.qb];
        if (V(a.s, P.g.vb) && V(a.s, P.g.Kb) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!lE(c, a))
    ...
    var pE = function(a, b, c) {
        ...
        if (!d)
            return b;
        var e, f = Na(null != (e = V(c.s, P.g.Vc)) ? e : 30);
        ...
        g.Ac = d.Ac + 1;
        var k;
        return null != (k = oE(g.sessionId, g.Ac, g.ld, g.Le, g.rh, g.xc, g.ue)) ? k : b
    }
      , sE = function(a, b) {
        var c = b.metadata.cookie_options
          , d = qE(b, c)
          , e = Wm(a, rE[0], c.domain, c.path)
          , f = {
            Db: P.g.T,
            domain: c.domain,
            path: c.path,
            expires: c.Ub ? new Date(Ta() + 1E3 * c.Ub) : void 0,
            flags: c.flags
        };
        Fm(d, void 0, f);
        return 1 !== Fm(d, e, f)
      ...
      , tE = function(a) {
        var b = a.metadata.cookie_options
          , c = qE(a, b)
          , d = Vm(c, b.domain, b.path, rE, P.g.T);
        if (!d)
            return d;
        var e = wm(c, void 0, void 0, P.g.T);
        if (d && 1 < e.length) {
            N(114);
            ...
            f && f.substring(f.length - d.length, f.length) !== d && (N(115),
      ...
      , uE = function(a) {
        return oE(a.h[P.g.yb], a.h[P.g.Qd], a.h[P.g.Pd], Math.floor(a.metadata.event_start_timestamp_ms / 1E3), a.metadata.join_timer_sec || 0, !!a.metadata[P.g.cf], a.h[P.g.Cd])
    };
    var vE = function(a) {
        var b = V(a.s, P.g.Ha)
          , c = a.s.C[P.g.Ha];
      ...
      , zE = function(a) {
        var b = vE(a) || {}
          ...
          , e = qE(a, c)
          , f = {};
        ao(b[P.g.Rc], !!b[P.g.U]) && (f = xE(a, d, e),
        f.clientId && f.Rf && (yE = !0));
        b[P.g.U] && Yn(function() {
            var g = {}
              , k = jE(a);
            k && (g[d] = k);
            var m = tE(a);
            m && (g[e] = m);
            var n = wm("FPLC", void 0, void 0, P.g.T);
            n.length && (g._fplc = n[0]);
            return g
        }, b[P.g.U], b[P.g.oc], !!b[P.g.Lb]);
        return f
    }
      , BE = function(a) {
        if (!V(a.s, P.g.zb))
        ...
        return !Tj("analytics_storage") && AE() ? wE(c, d) : {}
    }
      , AE = function() {
        var a = wn(z.location, "host")
          , b = wn(zn(F.referrer), "host");
    ...
    var DE = function(a, b) {
        ...
        T(82) && (gm(b.s) && (T(72) || BC()) ? T(46) && (a.npa = "0") : a.npa = "1")
    }
      , GE = function(a) {
        if (a.metadata.is_merchant_center)
            return "https://www.merchant-center-analytics.goog/mc/collect";
        var b = It(Kt(a.s), "/g/collect");
        if (b)
            return b;
        var c = WD(a)
          , d = V(a.s, P.g.pb);
        return c && !ij() && !1 !== d && AC() && Tj(P.g.J) && Tj(P.g.T) ? EE() : FE()
    }
      , HE = !1;
    HE = !0;
    var IE = {};
    ...
    ME))
      ...
      , OE = function(a, b, c) {
        ...
        d.v = "2";
        d.tid = a.target.da;
        up(a, "google_ono", !1) && !ij() && (d._ono = 1);
        d.gtm = $m(tp(a));
        d._p = T(105) ? Ai : gE();
        c && (d.em = c);
        a.metadata.create_google_join && (d._gaz = 1);
        DE(d, a);
        T(44) && (pm() && (d.dma_cps = mm()),
        d.dma = om());
        T(72) && Jl(Sl()) && (d.tcfd = qm());
        var g = a.h[P.g.ub];
        g && (d.gdid = g);
        ...
        l(a.h, function(t, u) {
            if (void 0 !== u && !Wh.hasOwnProperty(t)) {
                null === u && (u = "");
                var v;
                t !== P.g.Cd ? v = !1 : a.metadata.euid_mode_enabled || q ? (d.ecid = u,
                v = !0) : v = void 0;
                if (!v && t !== P.g.cf) {
                    var w = u;
                    !0 === u && (w = "1");
                    ...
                    if (IE[t])
                        ...
                        var y;
                        LE[t] ? y = !0 : t !== P.g.Gc ? y = !1 : ("object" !== typeof u && p(t, u),
                        y = !0);
                        y || p(t, u)
                    }
                }
        ...
        (function(t) {
            XD(a) && "object" === typeof t && l(t || {}, function(u, v) {
                "object" !== typeof v && (d["sst." + u] = String(v))
            })
        }
        )(a.h[P.g.me]);
        var r = a.h[P.g.Ua] || {};
        T(82) || (gm(a.s) && (T(72) || BC()) ? T(46) && (r._npa = "0") : r._npa = "1");
        T(12) && !1 === V(a.s, P.g.pb) && (d.ngs = "1");
        l(r, function(t, u) {
            void 0 !== u && ((null === u && (u = ""),
            t !== P.g.Na || f.uid) ? b[t] !== u && (e[(Ea(u) ? "upn." : "up.") + String(t)] = String(u),
    ...
    var VE = function(a, b, c, d) {
        ...
        var k = a + "?" + b;
        TE && (d = !(0 === k.indexOf(FE()) || 0 === k.indexOf(EE())));
        d && !aE ? SE(k, c) : UE(a, b, c)
    }
      , WE = function(a, b) {
        function c(r) {
        ...
        if (d || e) {
            ...
            c("gtm");
            p.push("aip=1");
            a.Bc.uid && !n && p.push("uid=" + encodeURIComponent("" + a.Bc.uid));
            d && (UE("https://stats.g.doubleclick.net/g/collect", "v=2&" + p.join("&")),
            Mj("https://stats.g.doubleclick.net/g/collect?v=2&" + p.join("&")));
            if (e) {
                p.push("z=" + Ja());
                if (!m) {
    ...
    XE.prototype.D = function(a, b) {
        ...
        Ps(a.s.eventId, a.eventName)
    }
    ;
    XE.prototype.add = function(a) {
        a.metadata.euid_mode_enabled && !aE ? this.X(a) : this.D(a)
    }
    ;
    XE.prototype.flush = function() {
        if (this.h.events.length) {
            var a = ig(this.h, this.I++);
            VE(this.h.h, a.xh, a.body, this.h.C);
            this.h = new fg;
      ...
      , bF = function(a) {
        if (XD(a)) {
            ...
            var c = function(e) {
              ...
              , d = V(a.s, P.g.za);
            void 0 !== d ? (c(d),
            T(86) && (a.h[P.g.ae] = "c")) : c(a.metadata.user_data);
    ...
    var cF = window
      ...
      , eF = function(a) {
        ...
        if (b && b.ioo && b.ioo() || dF.documentElement.hasAttribute("data-google-analytics-opt-out") || a && !0 === cF["ga-disable-" + a])
            return !0;
        try {
            var c = cF.external;
    ...
    var gF = function(a) {
        return !a || fF.test(a) || Yh.hasOwnProperty(a)
    }
      , hF = function(a) {
        var b = P.g.xb, c;
        c || (c = function() {}
    ...
    kF[P.g.Ic] = 1,
    kF)
      , fF = /^(_|ga_|google_|gtag\.|firebase_).*$/
      , mF = function(a) {
        this.ac = a;
        this.de = new XE;
        this.h = void 0;
    ...
    aa.gm = function(a, b, c) {
        ...
        if (e)
            if (c.eventMetadata.is_external_event && "_" === a.charAt(0))
                ...
                a !== P.g.oa && a !== P.g.Ja && gF(a) && N(58);
                nF(c.h);
                var f = new sp(e,a,c);
                f.metadata.event_start_timestamp_ms = b;
                var g = [P.g.T];
                (up(f, P.g.Jb, V(f.s, P.g.Jb)) || XD(f)) && g.push(P.g.J);
                T(63) && XD(f) && g.push(P.g.P);
                var k = function() {
                    Wj(function() {
                        d.hm(f)
                    }, g)
        ...
        try {
            if (eF(a.target.da))
                ...
                var c = nk(uk())
                  , d = c && c.parent;
                b = d ? nk(d) : void 0;
                if (b && Ga(b.destinations))
                    for (var e = 0; e < b.destinations.length; e++)
                        if (eF(b.destinations[e])) {
                            N(125);
                            a.isAborted = !0;
                            break
                        }
            }
            if (0 <= pn.Wk.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = ZD(a);
            ...
            "http:" != g && "https:" != g && (N(29),
            a.isAborted = !0);
            Cc && "preview" == Cc.loadPurpose && (N(30),
            a.isAborted = !0);
            T(43) && (a.isAborted = !0);
            Up(a);
            var k = li.grl;
            ...
            var m = {
                prefix: String(V(a.s, P.g.La, "")),
                path: String(V(a.s, P.g.Kc, "/")),
                flags: String(V(a.s, P.g.Ta, "")),
                domain: String(V(a.s, P.g.Sa, "auto")),
                Ub: Number(V(a.s, P.g.Fa, 63072E3))
            };
            a.metadata.cookie_options = m;
            oF(a);
            this.vk(a);
            this.I.Em(a);
            a.metadata.is_merchant_center ? a.metadata.euid_mode_enabled = !1 : up(a, "ccd_add_1p_data", !1) && (a.metadata.euid_mode_enabled = !0);
            if (a.metadata.euid_mode_enabled && up(a, "ccd_add_1p_data", !1)) {
                var n = a.s.C[P.g.be];
                if (Yi(n)) {
                    var p = V(a.s, P.g.za);
                    null === p ? a.metadata.user_data_from_code = null : (n.enable_code && mb(p) && (a.metadata.user_data_from_code = p),
                    mb(n.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = Xi(n.selectors)))
                }
            }
            var q = this.vj, r;
            V(a.s, P.g.zb) && (Tj(P.g.T) || V(a.s, P.g.qb) || (a.h[P.g.Ni] = !0));
            var t;
            var u;
            u = void 0 === u ? 3 : u;
            ...
            B && (this.M = !0);
            a.eventName == P.g.oa && (V(a.s, P.g.Ma, !0) ? (a.s.h[P.g.ba] && (a.s.D[P.g.ba] = a.s.h[P.g.ba],
            a.s.h[P.g.ba] = void 0,
            a.h[P.g.ba] = void 0),
            a.eventName = P.g.jc) : a.isAborted = !0);
            B && !a.isAborted && 0 < this.qf++ && eE(17);
            var D = bb(Xk(a.s, P.g.ba, 1), ".");
            D && (a.h[P.g.ub] = D);
            var G = bb(Xk(a.s, P.g.ba, 2), ".");
            G && (a.h[P.g.sb] = G);
            var E = this.D
              , H = this.I
              , O = !this.ee
            ...
            if (V(a.s, P.g.vb) && V(a.s, P.g.Kb))
                ...
                if (!U) {
                    var Y = Tj(P.g.T)
                      , S = fE();
                    U = !S.from_cookie || Y ? S.vid : void 0;
                    ha = 6
                }
                U ? U = "" + U : (U = Sm(),
                ha = 7,
            ...
            var ja = Math.floor(a.metadata.event_start_timestamp_ms / 1E3)
              , ma = void 0;
            a.metadata.is_new_to_site || (ma = tE(a) || E);
            var ea = Na(V(a.s, P.g.Vc, 30));
            ea = Math.min(475, ea);
            ea = Math.max(5, ea);
            var Ia = Na(V(a.s, P.g.lf, 1E4))
              , ua = nE(ma);
            a.metadata.is_first_visit = !1;
            a.metadata.is_session_start = !1;
            a.metadata.join_timer_sec = 0;
            ua && ua.rh && (a.metadata.join_timer_sec = Math.max(0, ua.rh - Math.max(0, ja - ua.Le)));
            var Fa = !1;
            ...
            if (Fa)
                ...
                H.xl(a);
            else if (H.nl() > Ia || a.eventName == P.g.jc)
                ua.ld = !0;
            a.metadata.euid_mode_enabled ? V(a.s, P.g.Na) ? ua.xc = !0 : (ua.xc && (ua.ue = void 0),
            ua.xc = !1) : ua.xc = !1;
            var Oa = ua.ue
              , jb = T(92) && XD(a);
            if (a.metadata.euid_mode_enabled || jb) {
                ...
                ic = 7);
                var Pd = ic
                  , Ng = a.metadata.enhanced_client_id_source;
                if (void 0 === Ng || Pd <= Ng)
                    a.h[P.g.Cd] = Db.toString(),
                    a.metadata.enhanced_client_id_source = Pd
            }
            O ? (a.copyToHitData(P.g.yb, ua.sessionId),
            a.copyToHitData(P.g.Qd, ua.Ac),
            a.copyToHitData(P.g.Pd, ua.ld ? 1 : 0)) : (a.h[P.g.yb] = ua.sessionId,
            a.h[P.g.Qd] = ua.Ac,
            a.h[P.g.Pd] = ua.ld ? 1 : 0);
            a.metadata[P.g.cf] = ua.xc ? 1 : 0;
            pF(a);
            if (!V(a.s, P.g.Kb) || !V(a.s, P.g.vb)) {
                var mv = ""
                  , Og = F.location;
                if (Og) {
                    var Si = Og.pathname || "";
                    "/" != Si.charAt(0) && (Si = "/" + Si);
                    mv = Og.protocol + "//" + Og.hostname + Si + Og.search
                }
                a.copyToHitData(P.g.ya, mv, iF);
                var rH = a.copyToHitData, sH = P.g.Ia, Ti;
                a: {
                    var nv = wm("_opt_expid", void 0, void 0, P.g.T)[0];
                    if (nv) {
                    ...
                    if (void 0 !== li.ga4_referrer_override)
                        Ti = li.ga4_referrer_override;
                    else {
                        var pv = Li("gtm.gtagReferrer." + a.target.da)
                          , tH = F.referrer;
                        Ti = pv ? "" + pv : tH
                    }
                }
                rH.call(a, sH, Ti || void 0, iF);
                a.copyToHitData(P.g.wb, F.title);
                a.copyToHitData(P.g.Ga, (Cc.language || "").toLowerCase());
                var qv = $p();
                a.copyToHitData(P.g.xb, qv.width + "x" + qv.height);
                T(30) && a.copyToHitData(P.g.Tc, void 0, iF);
                T(75) && Zp() && a.copyToHitData(P.g.ff, "1")
            }
            a.metadata.create_dc_join = !1;
            a.metadata.create_google_join = !1;
            if (!(T(53) && XD(a) || a.metadata.is_merchant_center || !1 === V(a.s, P.g.pb)) && AC() && Tj(P.g.J)) {
                var rv = WD(a);
                (a.metadata.is_session_start || V(a.s, P.g.rg)) && (a.metadata.create_dc_join = !!rv);
                var sv;
                sv = a.metadata.join_timer_sec;
                rv && 0 === (sv || 0) && (a.metadata.join_timer_sec = 60,
                a.metadata.create_google_join = !0)
            }
            qF(a);
            $h.hasOwnProperty(a.eventName) && (a.metadata.is_ecommerce = !0,
            a.copyToHitData(P.g.aa),
            a.copyToHitData(P.g.ra));
            a.copyToHitData(P.g.pf);
            for (var tv = V(a.s, P.g.ef) || [], Jm = 0; Jm < tv.length; Jm++) {
                var uv = tv[Jm];
                if (uv.rule_result) {
                    a.copyToHitData(P.g.pf, uv.traffic_type);
                    eE(3);
                    break
                }
            }
            if (!a.metadata.is_merchant_center && Kt(a.s)) {
                var vv = vE(a) || {}
                  , vH = (ao(vv[P.g.Rc], !!vv[P.g.U]) ? Rn(!0)._fplc : void 0) || (0 < wm("FPLC", void 0, void 0, P.g.T).length ? void 0 : "0");
                a.h._fplc = vH
            }
            if (void 0 !== V(a.s, P.g.Qc))
                a.copyToHitData(P.g.Qc);
            else {
                var wv = V(a.s, P.g.jf), Km, Ui;
                a: {
                    if (yE) {
                        var Lm = vE(a) || {};
                        if (Lm && Lm[P.g.U])
                            for (var xv = xn(zn(a.h[P.g.Ia]), "host", !0), Vi = Lm[P.g.U], Pg = 0; Pg < Vi.length; Pg++)
                                if (Vi[Pg]instanceof RegExp) {
                                    if (Vi[Pg].test(xv)) {
                                        Ui = !0;
                                        break a
                                    }
                                } else if (0 <= xv.indexOf(Vi[Pg])) {
                                    Ui = !0;
                                    break a
                                }
                    }
                ...
                if (!(Km = Ui)) {
                    ...
                    if (Wi = wv)
                        a: {
                            for (var yv = wv.include_conditions || [], wH = xn(zn(a.h[P.g.Ia]), "host", !0), Mm = 0; Mm < yv.length; Mm++)
                                if (yv[Mm].test(wH)) {
                                    Wi = !0;
                                    break a
                                }
            ...
            Fj() && $D(a, "rnd", Xm()));
            if (T(22) && XD(a)) {
                up(a, P.g.Jb, !1) && $D(a, "gse", 1);
                !1 === V(a.s, P.g.pb) && $D(a, "ngs", 1);
                ij() && $D(a, "ga_rd", 1);
                AC() || $D(a, "ngst", 1);
                var zv = lj();
                zv && $D(a, "etld", zv)
            ...
            XD(a) && (Fj() || T(38)) && ((Gj() || T(42)) && $D(a, "gcd", lm(a.s)),
            V(a.s, P.g.qa) && $D(a, "adr", 1));
            if (XD(a)) {
                var Bv = sr();
                Bv && $D(a, "us_privacy", Bv);
                var Cv = $l();
                Cv && $D(a, "gdpr", Cv);
                var Dv = Zl();
                Dv && $D(a, "gdpr_consent", Dv)
            }
            T(66) && XD(a) && (a.h[P.g.Fi] = hj() || gj());
            if (XD(a) && T(74)) {
                var Ev = Ai;
                Ev && $D(a, "tft", Number(Ev))
            }
            T(83) && XD(a) && (a.metadata.speculative && $D(a, "sp", 1),
            a.metadata.is_syn && $D(a, "syn", 1),
            a.metadata.em_event && ($D(a, "em_event", 1),
            $D(a, "sp", 1)));
            if (T(7))
                if (!ln(z))
                    N(87);
                    ...
                    N(85);
                    var Fv = jn();
                    Fv ? V(a.s, P.g.Nd) && !XD(a) || rn(Fv, a) : N(86)
                }
            if (T(29)) {
                var Nm = ar($q());
                Nm || rF || (rF = !0,
            ...
            xp(a);
            bF(a);
            T(83) && XD(a) && (a.metadata.speculative = !1);
            var Jv = V(a.s, P.g.vb);
            Jv && eE(12);
            a.metadata.em_event && eE(14);
            var Qg = nk(uk());
            (Jv || yk(Qg) || Qg && Qg.parent && Qg.context && 5 === Qg.context.source) && eE(19);
            !this.M && a.metadata.em_event && eE(18);
            ...
            var yH = this.vj, Lv, zH = this.h, Qm;
            a: {
                var Rm = uE(a);
                if (Rm) {
                    if (sE(Rm, a)) {
            ...
            this.Bm(a);
            if (XD(a)) {
                var BH = a.metadata.is_conversion;
                if ("page_view" === a.eventName || BH)
                    jF(this, a, P.g.J),
                    T(63) && jF(this, a, P.g.P)
            }
            this.I.Dh();
            a.copyToHitData(P.g.sg);
            V(a.s, P.g.Nd) && (a.h[P.g.Nd] = !0,
            XD(a) || hF(a));
            if (a.isAborted) {
                a.s.onFailure();
                Ab();
    ...
    ;
    aa.vk = function(a) {
        a.eventName !== P.g.Ja && this.I.uk(a)
    }
    ;
    var oF = function(a) {
        function b(c, d) {
      ...
      , pF = function(a) {
        ...
        mb(b[P.g.Gc]) ? l(b[P.g.Gc], function(d, e) {
            c((P.g.Gc + "_" + d).toLowerCase(), e)
        }) : l(b, c)
    }
      , qF = function(a) {
        var b = function(c) {
        ...
        a.metadata.is_conversion = b(ZD(a));
        a.metadata.is_first_visit && (a.metadata.is_first_visit_conversion = b(ZD(a, "first_visit")));
        a.metadata.is_session_start && (a.metadata.is_session_start_conversion = b(ZD(a, "session_start")))
    }
      , rF = !1;
    function nF(a) {
        l(a, function(c) {
    ...
    ;var sF = function(a) {
        if (T(58) && "prerendering"in F ? F.prerendering : "prerender" === F.visibilityState)
            return !1;
        a();
        return !0
    }
      , tF = function(a) {
        if (!sF(a)) {
            var b = !1
              , c = function() {
                !b && sF(a) && (b = !0,
                Oc(F, "visibilitychange", c),
                T(58) && Oc(F, "prerenderingchange", c),
                N(55))
            };
            Nc(F, "visibilitychange", c);
            T(58) && Nc(F, "prerenderingchange", c);
            N(54)
        }
    };
    var vF = function(a, b) {
    ...
    function wF(a, b, c) {
        ...
        d.jm(function() {
            aE = !0;
            $v.flush();
            1E3 <= d.Gf() && Cc.sendBeacon && bw(P.g.sd, {}, a.id, f);
            b.flush();
            d.wj(function() {
                aE = !1;
                d.wj()
    ...
    VF.N = "parseUrl";
    function WF(a) {
        L(K(this), ["preHit:!PixieMap"], arguments);
        var b = md(a, this.h, 1).jj()
          , c = C(b.s.h);
        C(b.h, c);
        var d = C(b.metadata);
        d.syn_or_mod = !0;
        var e = {
          ...
          , f = b.s.eventId
          , g = Yu(b.target.da, b.eventName, c);
        av(g, f, e);
    }
    ...
    hG.N = "resetDataLayer";
    function iG(a, b, c, d) {
        L(K(this), ["destinationIds:!*", "eventName:!*", "eventParameters:?PixieMap", "messageContext:?PixieMap"], arguments);
        var e = c ? md(c) : {}
          , f = md(a);
        Array.isArray(f) || (f = [f]);
        b = String(b);
    ...
    function sG(a, b, c) {
        L(K(this), ["targetId:!string", "name:!string", "value:!*"], arguments);
        for (var d = b.split("."), e = ew(a), f = 0; f < d.length - 1; f++) {
            if (void 0 === e[d[f]])
                e[d[f]] = {};
            else if (!mb(e[d[f]]))
    ...
    vG.getItem = function(a) {
        ...
        var d = c.bd();
        wG[d] && (b = wG[d].hasOwnProperty("gtm." + a) ? wG[d]["gtm." + a] : null);
        return b
    }
    ;
    ...
    vG.removeItem = function(a) {
        ...
        if (!b)
            throw Error("invalid program state");
        var c = b.bd();
        if (!wG[c] || !wG[c].hasOwnProperty("gtm." + a))
            return;
        delete wG[c]["gtm." + a];
    }
    ;
    ...
    function xG(a, b) {
        var c = !1;
        L(K(this), ["regex:!OpaqueValue", "testString:!string"], arguments);
    ...
    function() {
        (function(a) {
            ...
            Iy(a.vtp_value, "c", a.vtp_gtmEventId);
            return a.vtp_value
        })
    }();
    Z.m.e = ["google"],
    ...
    function() {
        ...
        (function(b) {
            ...
            0 < d && (c[P.g.Vc] = d);
            c[P.g.Fd] = b.vtp_eventSettings;
            c[P.g.gg] = b.vtp_dynamicEventSettings;
            c[P.g.Jb] = 1 === b.vtp_googleSignals;
            c[P.g.ug] = b.vtp_foreignTld;
            c[P.g.qg] = 1 === b.vtp_restrictDomain;
            c[P.g.ef] = b.vtp_internalTrafficResults;
            var e = P.g.Ha
              , f = b.vtp_linker;
            f && f[P.g.U] && (f[P.g.U] = a(f[P.g.U]));
            c[e] = f;
            var g = P.g.jf
    ...
    function() {
        (function(a) {
            ...
            var f = Yu(String(b.streamId), d, c);
            av(f, e.eventId, e);
            a.vtp_gtmOnSuccess()
        })
    }();
    ...
    (function(a) {
        ...
        if (xi)
            ...
            var f = function(u) {
                ...
                Jc("https://" + ki.Ve + "/debug/bootstrap?id=" + Qf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + $m()));
                var y = {
        ...
        try {
            ...
            if (ak().canonical[a]) {
                ...
                dI();
                if (T(38) && !xi) {
                    for (var S = fj["7"], ja = S ? S.split("|") : [], ma = {}, ea = 0; ea < ja.length; ea++)
                        ma[ja[ea]] = !0;
